...
else
{
    ...
    if ($message != "")
    {
        ...
        $sql = "INSERT INTO chatotp (channel,username,message) VALUES('$channel','$username','$message')";
        mysqli_query($kon, $sql);
    }

}
$channel = $_POST['channel'];
$sql = "SELECT * FROM chatotp WHERE channel = '$channel' ORDER BY id DESC";
